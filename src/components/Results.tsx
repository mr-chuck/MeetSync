...
const Results: React.FC<ResultsProps> = ({ onNavigate, meetingCode }) => {
  ...
  const formatTimeSlot = (isoString: string) => {
    ...
    return {
      ...
      fullDate: date.format('dddd, MMMM D, YYYY'),
    };
  };
  ...
  return (
    <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl shadow-lg p-8 mb-8 border border-green-200">
          ...
          <div className="grid gap-4">
            {bestSlots.map((bestSlot) => {
              ...
              return (
                <div key={bestSlot.slot} className="bg-white rounded-xl p-6 shadow-sm border border-green-200">
                  <div className="flex items-center justify-between">
                    <div>
                      <h3 className="text-lg font-semibold text-gray-900">{formatted.time}</h3>
                      <p className="text-gray-600">{formatted.fullDate}</p>
                    </div>
                    <div className="text-right">
                      <div className="text-2xl font-bold text-green-600">{bestSlot.votes}</div>
      ...
      <div className="bg-white rounded-2xl shadow-lg p-6 mb-8">
        <h2 className="text-lg font-semibold text-gray-900 mb-6">All Time Slots</h2>
              ...
              return (
                ...
                >
                  <div className="flex items-center justify-between mb-3">
                    <div>
                      <div className="font-medium text-gray-900">{formatted.time}</div>
                      <div className="text-sm text-gray-600">{formatted.date}</div>
                    </div>
                    <div className="text-right">
                      <div className="font-semibold text-gray-900">
                        {summary.votes} / {totalParticipants}
                      </div>
